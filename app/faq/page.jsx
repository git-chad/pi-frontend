    ...
    const questions = [
        {
            ...
            There, you'll need to use your personal information for registration and a valid email, as we'll send you a validation email so you can start using your account</>
        },
        {
